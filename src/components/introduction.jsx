                                        ...
                                        <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                                            <div className="slider-text-inner js-fullheight">
                                                <div className="desc">
                                                    ...
                                                    <p><a className="btn btn-primary btn-learn" href="resume/Saugat_Adhikari.pdf" target="_blank" rel="noopener noreferrer">Download CV<i className="icon-download4" /></a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
